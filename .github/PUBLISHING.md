...
2. Add a new pending publisher:
   - **PyPI project name**: lynx-investor-communication-services
   - **Owner**: `borjatarraso`
   - **Repository**: `lynx-investor-communication-services`
...
# then:
git tag -a v5.2 -m "lynx-investor-communication-services v5.2"
