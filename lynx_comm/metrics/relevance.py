"""Metric relevance by company tier AND Communication Services lifecycle stage.

Defines which metrics are CRITICAL, IMPORTANT, RELEVANT, CONTEXTUAL (informational)
or IRRELEVANT for each combination of company size tier and Communication Services
business stage.

For Communication Services analysis:
...
Stage axis (Communication Services-specific):
  STARTUP    - Startup / Early-Stage
  GROWTH     - Subscriber / User Growth
  SCALE      - Scale-Up (national / international rollout)
  MATURE     - Mature / Cash-Generative (carriers, mature platforms)
  PLATFORM   - Dominant Platform (Big Internet, tier-1 carrier)

Example: For a GROWTH-stage streaming company, ARPU, churn, and subscriber
net adds are CRITICAL, P/E is IRRELEVANT, and EV/Subscriber is IMPORTANT.
For a MATURE-stage telecom, FCF yield, dividend coverage, and net debt/EBITDA
dominate.
"""

from __future__ import annotations

from lynx_comm.models import CompanyStage, CompanyTier, Relevance
...
def get_relevance(
    ...
    for communication services analysis (lifecycle dimension parallels other sector kits).
    """
    ...
    table = {
        ...
        "comm_quality": COMM_QUALITY_RELEVANCE,
...
_STAGE_OVERRIDES: dict[str, dict[CompanyStage, Relevance]] = {
    ...
    "churn_rate_annual":     {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "arpu_to_cpga_ratio":    {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    ...
    # Subscriber/user economics
    "subscribers":             {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "subscriber_net_adds":     {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: P},
    "subscriber_growth_yoy":   {CompanyStage.STARTUP: C, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    "arpu":                    {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "arpu_growth_yoy":         {CompanyStage.STARTUP: R, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "mau":                     {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    "dau":                     {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "dau_mau_ratio":           {CompanyStage.STARTUP: R, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "cost_per_gross_add":      {CompanyStage.STARTUP: C, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    "advertising_revenue_growth_yoy":{CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "revenue_per_subscriber":  {CompanyStage.STARTUP: P, CompanyStage.GROWTH: P, CompanyStage.SCALE: P, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    # Content economics (streaming/media)
    "content_intensity":       {CompanyStage.STARTUP: R, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: P},
    "content_growth_yoy":      {CompanyStage.STARTUP: R, CompanyStage.GROWTH: P, CompanyStage.SCALE: C, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    "content_amort_intensity": {CompanyStage.STARTUP: R, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: P},
    "content_roi":             {CompanyStage.STARTUP: R, CompanyStage.GROWTH: P, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "content_obligations":     {CompanyStage.STARTUP: X, CompanyStage.GROWTH: P, CompanyStage.SCALE: P, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    # Network capex (telecom/cable)
    "capex_to_subscriber":     {CompanyStage.STARTUP: R, CompanyStage.GROWTH: P, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: P},
    "spectrum_license_book_value":{CompanyStage.STARTUP: X, CompanyStage.GROWTH: R, CompanyStage.SCALE: P, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    "net_debt_to_ebitda":      {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    # Revenue mix
    "operating_margin_ex_content":{CompanyStage.STARTUP: R, CompanyStage.GROWTH: P, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: P},
    "advertising_revenue_pct": {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "subscription_revenue_pct":{CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    # Comm-services valuation
    "ev_to_subscriber":        {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: P},
    "ev_to_ebitda_capex_adj":  {CompanyStage.STARTUP: I, CompanyStage.GROWTH: R, CompanyStage.SCALE: P, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "fcf_yield":               {CompanyStage.STARTUP: I, CompanyStage.GROWTH: R, CompanyStage.SCALE: P, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "price_per_dau":           {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: P, CompanyStage.MATURE: P, CompanyStage.PLATFORM: P},
    # Quality assessments
    "network_quality_assessment":  {CompanyStage.STARTUP: R, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "content_library_assessment":  {CompanyStage.STARTUP: R, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "user_engagement_assessment":  {CompanyStage.STARTUP: R, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "leverage_assessment":         {CompanyStage.STARTUP: P, CompanyStage.GROWTH: C, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: C},
    "capex_cycle_assessment":      {CompanyStage.STARTUP: R, CompanyStage.GROWTH: P, CompanyStage.SCALE: C, CompanyStage.MATURE: C, CompanyStage.PLATFORM: P},
}
...
COMM_QUALITY_RELEVANCE: dict[str, dict[CompanyTier, Relevance]] = {
