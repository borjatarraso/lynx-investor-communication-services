...
from lynx_comm.core.storage import get_reports_dir, save_binary, save_json, save_text
from lynx_comm.models import Filing

DOWNLOAD_HEADERS = {"User-Agent": "Mozilla/5.0 (compatible; LynxComm/0.1)", "Accept-Encoding": "gzip, deflate"}
EDGAR_HEADERS = {"User-Agent": "LynxComm/0.1 lynx-comm-research@example.com", "Accept-Encoding": "gzip, deflate"}
