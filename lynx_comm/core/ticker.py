...
def resolve_identifier(identifier: str) -> tuple[str, str | None]:
    ...
    raise ValueError(
        ...
        "Tips:\n"
        "  - For US wireless carriers, try: T, VZ, TMUS\n"
        "  - For US cable, try: CMCSA, CHTR\n"
        "  - For internet platforms, try: GOOGL, META\n"
        "  - For streaming/media, try: NFLX, DIS, WBD\n"
        "  - For European carriers, try: VOD.L, TEF.MC, DTE.DE\n"
        "  - You can also type the full company name: 'T-Mobile US'"
    )
