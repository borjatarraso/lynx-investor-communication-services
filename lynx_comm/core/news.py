"""News fetching for Communication Services companies."""
...
from lynx_comm.core.storage import get_news_dir, save_json, save_text
from lynx_comm.models import NewsArticle
...
def download_article(ticker: str, article: NewsArticle) -> Optional[str]:
    ...
    try:
        resp = requests.get(article.url, timeout=15, allow_redirects=False, headers={"User-Agent": "Mozilla/5.0 (compatible; LynxComm/0.1)"})
