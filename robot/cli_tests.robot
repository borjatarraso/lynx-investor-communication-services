*** Settings ***
Documentation    CLI integration tests for lynx-comm
Library          Process
...
Given The Application Is Available
    Run App    --version
    Should Contain    ${OUTPUT}    lynx-comm
...
Show Help
    ...
    Then The Output Should Contain "lynx-comm"
...
Show About
    ...
    When I Run About
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Lynx Communication Services Analysis"
...
Explain A Comm-Services-Specific Metric Rule Of 40
...
Explain A Comm-Services-Specific Metric SBC
...
Explain A Section
    ...
    Given The Application Is Available
    When I Explain Section "comm_quality"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Sector Quality"
...
Search For A Comm Services Company
